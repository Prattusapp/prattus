...
export default function MealCountArchive() {
    ...
    <div className="space-y-6 animate-in fade-in duration-500 pb-10">
      <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Consulte o histórico de lançamentos agrupados por unidade.</p>
        </div>
      ...
      <div className="space-y-3">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4">
            ...
            <p className="text-muted-foreground animate-pulse">Buscando auditorias...</p>
          </div>
        ) : records.length > 0 ? (
          records.map((record) => (
            <div 
          ...
          <div className="flex flex-col items-center justify-center py-20 px-6 rounded-3xl border border-dashed border-border/50 bg-card/20 text-center">
            ...
            <h3 className="text-xl font-bold">Nenhuma auditoria encontrada</h3>
            <p className="text-muted-foreground max-w-sm mt-2">
              Não foram encontradas contagens no período selecionado. Tente ajustar os filtros acima.
            </p>
          </div>
        )}
      </div>
